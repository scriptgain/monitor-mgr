...
<div class="min-h-full flex flex-col lg:flex-row">
    ...
    <div class="lg:w-1/2 bg-chrome text-white px-8 py-12 lg:p-16 flex flex-col justify-between">
        ...
        <div class="hidden lg:block max-w-md">
            <h2 class="text-3xl font-semibold tracking-tight">Server &amp; Uptime Monitoring You Fully Control.</h2>
            <p class="mt-4 text-slate-300 leading-relaxed">
                One control panel for every host, check, and status page. Watch uptime, catch incidents the moment they start, and alert your team, all on your own infrastructure.
            </p>
            <ul class="mt-8 space-y-3 text-sm text-slate-300">
                <li class="flex items-center gap-2"><x-icon name="check-circle" class="w-5 h-5 text-brand-400" /> HTTP, TCP &amp; ping checks run from your own nodes</li>
                <li class="flex items-center gap-2"><x-icon name="check-circle" class="w-5 h-5 text-brand-400" /> Incident timeline with instant alerting</li>
                <li class="flex items-center gap-2"><x-icon name="check-circle" class="w-5 h-5 text-brand-400" /> Public status pages your customers can trust</li>
            </ul>
        </div>
