@php
    $cards = [
        ...
        ['Notifications', 'Email alerts for monitor and incident events.', 'bell', route('settings.notifications.edit'), true],
...
<x-layouts.app title="Settings">
    <x-page-header title="Settings" icon="settings" subtitle="Configure branding, notifications, tokens, and security." />
